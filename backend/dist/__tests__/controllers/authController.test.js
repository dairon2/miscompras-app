...
describe('Auth Controller Logic', () => {
    ...
    describe('Login Logic', () => {
        ...
        it('should compare passwords correctly', async () => {
            ...
            expect(await bcryptjs_1.default.compare(password, hashedPassword)).toBe(true);
            expect(await bcryptjs_1.default.compare('wrongPassword', hashedPassword)).toBe(false);
        });
        it('should generate valid JWT token', () => {
            const userData = { id: 'user-123', email: 'test@test.com', role: 'USER' };
            const secret = 'test-secret';
            const token = jsonwebtoken_1.default.sign(userData, secret, { expiresIn: '24h' });
    ...
    describe('Token Refresh Logic', () => {
        it('should verify refresh token', () => {
            ...
            const refreshToken = jsonwebtoken_1.default.sign(userData, secret, { expiresIn: '7d' });
        ...
        it('should throw error for expired token', () => {
            ...
            const expiredToken = jsonwebtoken_1.default.sign(userData, secret, { expiresIn: '-1s' });
            expect(() => jsonwebtoken_1.default.verify(expiredToken, secret)).toThrow();
        });
    });
