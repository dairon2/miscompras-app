...
describe('Budget Controller Logic', () => {
    ...
    describe('Budget Calculations', () => {
        it('should calculate available budget correctly', () => {
            const calculateAvailable = (amount, spent) => {
                return amount - spent;
            };
        ...
        it('should calculate execution percentage', () => {
            const calculateExecutionPercent = (amount, available) => {
                if (amount === 0)
                    return 0;
        ...
        it('should prevent negative available budget', () => {
            const safeDeduct = (available, amount) => {
                if (amount > available) {
    ...
    describe('Budget Filtering', () => {
        it('should filter budgets by year', () => {
            ...
            const filterByYear = (data, year) => data.filter(b => b.year === year);
        ...
        it('should filter budgets by area', () => {
            ...
            const filterByArea = (data, areaId) => data.filter(b => b.areaId === areaId);
        ...
        it('should filter budgets by project', () => {
            ...
            const filterByProject = (data, projectId) => data.filter(b => b.projectId === projectId);
    ...
    describe('Budget Status', () => {
        it('should determine budget status based on execution', () => {
            const getBudgetStatus = (available, amount) => {
    ...
    describe('Budget Aggregations', () => {
        it('should calculate total budget for an area', () => {
            ...
            const getTotalForArea = (data, areaId) => {
                return data
        ...
        it('should calculate total available across all budgets', () => {
            ...
            const getTotalAvailable = (data) => data.reduce((sum, b) => sum + b.available, 0);
            const getTotalAmount = (data) => data.reduce((sum, b) => sum + b.amount, 0);
