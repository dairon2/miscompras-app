...
// Budgets CRUD
app.get('/api/budgets', auth_1.authMiddleware, (req, res) => {
    res.json(demoBudgets);
});
app.post('/api/budgets', auth_1.authMiddleware, (0, auth_1.roleCheck)(['ADMIN', 'DIRECTOR']), (req, res) => {
...
app.put('/api/budgets/:id', auth_1.authMiddleware, (0, auth_1.roleCheck)(['ADMIN', 'DIRECTOR']), (req, res) => {
    const { id } = req.params;
    const { amount, projectId, areaId, managerId, categoryId, executionDate } = req.body;
    ...
    if (index !== -1) {
        ...
        demoBudgets[index] = {
            ...
            categoryId,
            category: category || demoBudgets[index].category,
            executionDate: executionDate || demoBudgets[index].executionDate
        };
...
app.delete('/api/budgets/:id', auth_1.authMiddleware, (0, auth_1.roleCheck)(['ADMIN', 'DIRECTOR']), (req, res) => {
    const { id } = req.params;
    const index = demoBudgets.findIndex(b => b.id === id);
    if (index !== -1) {
