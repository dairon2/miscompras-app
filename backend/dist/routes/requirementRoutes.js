...
router.put('/mass-update', (0, auth_1.roleCheck)(['ADMIN', 'DIRECTOR', 'LEADER', 'COORDINATOR', 'DEVELOPER']), requirementController_1.updateMassRequirements);
router.post('/', upload.array('attachments'), requirementController_1.createRequirement);
router.post('/mass-create', upload.any(), requirementController_1.createMassRequirements);
...
router.patch('/:id/status', (0, auth_1.roleCheck)(['DIRECTOR', 'COORDINATOR', 'DEVELOPER']), requirementController_1.updateRequirementStatus);
