                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="relative" ref={notifRef}>
                    ...
                    >
                      ...
                      {unreadCount > 0 && (
                        <span className="absolute -top-1 -right-1 min-w-[20px] h-5 px-1.5 bg-red-500 text-white text-[10px] font-black rounded-full flex items-center justify-center shadow-lg">
                        ...
                        >
                          <div className="p-8 border-b border-slate-800 bg-[#1e293b]/30">
                            ...
                            <div className="flex flex-col items-center">
                              <div className="w-20 h-20 rounded-full bg-premium-gradient flex items-center justify-center mb-4 shadow-2xl ring-4 ring-slate-800/50 overflow-hidden">
                                {user?.profilePhoto ? (
                                  <img src={user.profilePhoto} alt={user.name || 'Foto'} className="w-full h-full object-cover" />
                                ) : (
