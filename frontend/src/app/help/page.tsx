                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:soporte@museo.com" className="font-bold hover:text-amber-500 transition-colors">
                                            soporte@museo.com
                                        </a>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+576044441234" className="font-bold hover:text-amber-500 transition-colors">
                                            +57 604 444 1234
                                        </a>
                                    </div>
                                </div>
